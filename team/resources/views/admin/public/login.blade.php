...
<head>
    ...
    <![endif]-->
    <link href="/statics/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css"/>
    <link href="/statics/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css"/>
    <link href="/statics/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css"/>
    ...
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="{{ route('login') }}" method="post">
            ...
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-xs-8">
                    <input name="userpwd" type="password" placeholder="密码" class="input-text size-L">
                </div>
            </div>
            {{ csrf_field() }}
            <div class="row cl">
