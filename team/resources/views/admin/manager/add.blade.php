    ...
    <form action="" method="post" class="form form-horizontal" name="file" id="form-member-add" enctype="multipart/form-data">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="姓名" id="username" name="username">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="密码" id="userpwd" name="userpwd">
            </div>
        </div>
