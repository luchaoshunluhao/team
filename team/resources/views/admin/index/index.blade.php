...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="{{ route('matchdata_index') }}" data-title="比赛数据管理" href="javascript:void(0)">比赛数据列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="{{ route('matchinfo_index') }}" data-title="比赛信息管理" href="javascript:void(0)">比赛信息列表</a></li>
                    <li><a data-href="{{ route('matchscore_index') }}" data-title="比赛分数管理" href="javascript:void(0)">比赛分数列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="{{ route('Sportsman_index')}}" data-title="运动员列表" href="javascript:void(0)">运动员列表</a></li>
