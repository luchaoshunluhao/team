...
<div class="layui-carousel" id="lunbo1">
    <div carousel-item>
        <div class="lunbo">
            <img src="/statics/picture/banner_1.jpg" alt="">
        </div>
        <div class="lunbo">
            <img src="/statics/picture/banner_1.jpg" alt="">
        </div>
...
<div class="layui-fluid xinkon_bg">
    <div class="layui-container list_bg_ahp">
        ...
        <div class="layui-row">
            <form class="layui-form" action="{{ route('default') }}">
                <div class="demoTable">
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="city" lay-verify="" lay-search id="demoReload7">
                            <option value="">横直拍</option>
                            <option value="直拍">直拍</option>
            ...
            <div class="demoTable1">
                <div class="layui-inline layui-col-xs3">
                    <select name="city" lay-verify="" lay-search id="sou_one" class="layui-input layui_select">
                        ...
                        @foreach($user_name as $item)
                            <option value="{{ $item->id }}" class="option_item">{{ $item->user_name }}</option>
                        @endforeach
                    </select>
                </div>
...
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
<script src="/statics/js/html5.min.js"></script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'a_user', title: '运动员A', sort: true, width: 80}
                , {field: 'b_user', title: '运动员B', sort: true, width: 80}
...
<script>
    layui.use('table', function () {
        ...
        table.on('tool(user)', function (obj) {
            ...
            if (obj.event === 'detail') {
                location.href = '{{ route('list') }}' + '?mess_id=' + data;
